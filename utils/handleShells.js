/**
 * Check quadrant
 * @param {number} deg - as angle need check
 * @return {Array} Array of two element, element 1 as quadrant, element 2 as mini angle
 */

exports.checkQuadrant = (deg) => {
...
/**
 * @param {number} deg - as angle need convert to radius
 * @return {number} - radius after convert
 */

exports.convertDegToRadian = (deg) => {
  return (deg * Math.PI) / 180
}

/**
 * @param {number} radius - as radius of atom
 * @param {number} deg - as angle of electron edge x or y
 * @return {Array}  - Margin top and margin left of electron
 */

exports.getDistance = (radius, deg) => {
...
/**
 * @param {Array} arrRadius - array radius of atom need convert
 * @param {Array} shells - shells of element
 */
exports.getMtAndMl = (arrRadius, shells) => {
  const mtAndMl = []
  let deg = 0
  let arr = []
  let divDeg = 0
...
/**
 * @param {number} electron - number electron of element need convert to shells of element
 * @return {Array} - shells of element
 */

exports.convertElectron = (electron) => {
